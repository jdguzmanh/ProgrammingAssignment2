...
cacheSolve <- function(x, ...) {
	...
	m <-x$getminv()
	## Assesses whether the control variable is null, obtinte not be the inverse of the global variable / Evalúa si la variable de control es nula, de no serlo obtinte la matrix inversa de la variable global
	if(!is.null(m)){
